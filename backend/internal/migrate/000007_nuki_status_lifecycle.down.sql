...
ALTER TABLE nuki_access_codes RENAME TO nuki_access_codes_new;
...
SELECT
    ...
    valid_until,
    CASE
        WHEN status = 'generated' THEN 'active'
    ...
    updated_at,
    revoked_at
FROM nuki_access_codes_new;

DROP TABLE nuki_access_codes_new;
